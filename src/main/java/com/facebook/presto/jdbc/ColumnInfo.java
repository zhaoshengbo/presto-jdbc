...
class ColumnInfo {
    ...
    public ColumnInfo(
        ...
        } else if (typeString.equals("time with time zone")) {
            builder.setSigned(true);
            builder.setPrecision(3);
            builder.setScale(0);
        ...
        } else if (typeString.equals("timestamp with time zone")) {
            builder.setSigned(true);
            builder.setPrecision(3);
            builder.setScale(0);
        ...
        } else if (typeString.equals("interval year to month")) {
            builder.setColumnDisplaySize(TIMESTAMP_MAX);
        } else if (typeString.equals("interval day to second")) {
            builder.setColumnDisplaySize(TIMESTAMP_MAX);
    ...
    private static int getType(TypeSignature type) {
        ...
        String baseString = type.getBase();
        if (baseString.equals("boolean")) {
            return Types.BOOLEAN;
        } else if (baseString.equals("bigint")) {
            return Types.BIGINT;
        } else if (baseString.equals("integer")) {
            return Types.INTEGER;
        } else if (baseString.equals("smallint")) {
            return Types.SMALLINT;
        } else if (baseString.equals("tinyint")) {
            return Types.TINYINT;
        } else if (baseString.equals("real")) {
            return Types.REAL;
        } else if (baseString.equals("double")) {
            return Types.DOUBLE;
        } else if (baseString.equals("varchar")) {
            return Types.LONGNVARCHAR;
        } else if (baseString.equals("char")) {
            return Types.CHAR;
        } else if (baseString.equals("varbinary")) {
            return Types.LONGVARBINARY;
        } else if (baseString.equals("time")) {
            return Types.TIME;
        } else if (baseString.equals("time with time zone")) {
            return Types.TIME;
        } else if (baseString.equals("timestamp")) {
            return Types.TIMESTAMP;
        } else if (baseString.equals("timestamp with time zone")) {
            return Types.TIMESTAMP;
        } else if (baseString.equals("date")) {
            return Types.DATE;
        } else if (baseString.equals("decimal")) {
