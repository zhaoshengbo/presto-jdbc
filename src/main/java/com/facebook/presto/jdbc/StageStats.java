...
public final class StageStats {
    ...
    static StageStats create(com.facebook.presto.client.StageStats stats) {
        ...
        List<StageStats> subStageStatsList = new ArrayList<StageStats>();
        for (com.facebook.presto.client.StageStats subStageStats : stats.getSubStages()) {
            subStageStatsList.add(StageStats.create(subStageStats));
        }
